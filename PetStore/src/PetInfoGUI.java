...
public class PetInfoGUI {
    ...
    public PetInfoGUI(User user) {
        ...
        JButton viewOrderButton = new JButton("查看订单详情");
        viewOrderButton.addActionListener(e -> showOrderDetail(user));
        orderButtonPanel.add(viewOrderButton);

        southPanel.add(orderButtonPanel);
    ...
    private void showOrderDetail(User user){
        new UserOrderDetailsGUI(user);
